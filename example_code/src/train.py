...
train_df = pd.read_csv("../data/kaggle/tweet-sentiment-extraction/train.csv")
...
Path("../data/model_trained").mkdir(parents=True, exist_ok=True)
...
for fold, (train_idx, val_idx) in enumerate(
    ...
    train_model(
        ...
        optimizer,
        num_epochs,
        f"../data/model_trained/roberta_fold{fold}.pth",
    )
